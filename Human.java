public class Human implements Participant, Robot_inter {
    protected String name;
    private final int maxRun;
    private final int maxJump;
    private int abilityCount = 1; // Индивидуальное количество superRun для человека
...
// Реализует поведение человека в соревновании.